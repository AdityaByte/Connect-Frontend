...
export const GreetWindow = ({ username }) => {
    ...
    return (
        <div className="w-full h-full flex flex-col justify-center items-center text-white px-10 box-border gap-10">
            ...
            <button onClick={() => dispatch(changeTab("CHAT"))} className="px-5 py-3 text-green-900 font-bold text-sm hover:bg-green-400 active:bg-green-600 bg-green-200 rounded">Join rooms</button>
        </div>
    )
}